...
dataset = pd.read_csv(R'C:\Users\chait\Desktop\DATA SCIENCE\Udamy\original\Machine Learning A-Z (Codes and Datasets)\Part 2 - Regression\Section 4 - Simple Linear Regression\Python\Salary_Data.csv')
